...
- Superseded extension WebSockets are now terminated immediately instead of relying on a peer close handshake.
- Rejected extension WebSockets now have a bounded termination fallback when the policy close handshake stalls.
