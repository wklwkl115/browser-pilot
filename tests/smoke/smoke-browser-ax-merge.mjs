...
try {
  ...
  const axEntities = await readAxEntities(bridge, { browserSessionId: bridge.snapshot().browserSessionId, tabId, observationId: "ax-smoke", url: fixtureUrl, capturedAt: Date.now(), timeoutMs: 10000 });
