	...
	},
	{
		...
		fixture: {
			entities: [
				...
				entity("bp-ref://item-file-2", { kind: "element", role: "listitem", name: "tests/memory/observeRegressionBenchmark.test.ts modified", structure: { setSize: 4, posInSet: 2 }, hints: { containerRole: "list", containerName: "Changed files", selector: ".file-list li:nth-child(2)" } }),
			...
			pageObservation: {
				content: "browser-pilot Pull requests Review changes Changed files src/commands/observe/scanRunner.ts tests/memory/observeRegressionBenchmark.test.ts CODE_WIKI.md",
