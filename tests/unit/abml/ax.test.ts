...
import { buildAxEntityFromNode, boxModelToGeometry, mergeDomAndAxEntities } from "../../../src/abml/ax.ts";
...
test("abml ax merges matching DOM and AX entities by role/name/geometry", () => {
	...
	const ax = [buildAxEntityFromNode({ nodeId: "ax-1", backendDOMNodeId: 81, role: { value: "button" }, name: { value: "Pay now" } }, { observationId: "obs-1" }, { point: { x: 104, y: 198 } })];
