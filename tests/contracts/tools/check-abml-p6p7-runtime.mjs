...
assert(scanSrc.includes("collectCanvasRegions") && summarySrc.includes("visual_regions"), "P7 scan/model layer must project canvas regions into internal visual region summaries");
