...
const serviceWorkerBridgeFiles = ["config.js", "protocol.js", "patterns.js", "cdp.js", "state_store.js", "runtime.js", ...waitBridgeRuntimeFiles, ...networkBridgeRuntimeFiles, "hook.js", "evidence.js", "frame.js", "html.js", "screenshot.js", "transfer.js", "bridge_info.js", "core_commands.js", "exec.js", "input.js", "ws_model.js", "ws.js", "router.js", "tab_sync.js", "transport.js"];
...
assert(pkg.scripts?.["verify:bridge:dist"] === "node tests/contracts/protocol/check-bridge-build.mjs", "package must expose a read-only bridge dist verification command");
...
assert(pkg.dependencies?.typescript || pkg.devDependencies?.typescript, "package must depend on TypeScript for bridge typecheck/build paths");
...
assert(existsSync(path.join(root, "docs", "archive", "hook-dispatcher-boundary.full.md")), "docs/archive/hook-dispatcher-boundary.full.md must freeze the page-injection boundary before bundler migration");
const hookBoundaryDoc = read("docs/archive/hook-dispatcher-boundary.full.md");
...
assert(existsSync(path.join(root, "docs", "archive", "bridge-esm-bundler-plan.full.md")), "docs/archive/bridge-esm-bundler-plan.full.md must freeze the ESM/bundler migration design before code migration");
const bridgeBundlerPlan = read("docs/archive/bridge-esm-bundler-plan.full.md");
