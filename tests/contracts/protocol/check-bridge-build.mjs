...
assert(coreCommandsSource.includes("chrome.tabs.sendMessage(tabId, { cmd: 'pi.contentFingerprint' })") && coreCommandsSource.includes("chrome.scripting.executeScript") && coreCommandsSource.includes("__piBrowserFingerprintFallbackState__"), "content.fingerprint must keep a content-script-first executeScript fallback for effect fingerprints");
