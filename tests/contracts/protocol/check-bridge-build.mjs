...
const commandModules = ["network_model", "network_events", "network", "hook", "evidence", "frame", "html", "screenshot", "transfer", "bridge_info", "core_commands", "exec", "input", "ws_model", "ws"];
...
assert(Buffer.byteLength(bundle, "utf8") < 416_000, "dist service-worker bundle must stay below the whitespace-minified size budget");
