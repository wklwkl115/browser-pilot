...
async function main() {
	...
	assert.deepEqual(listProdDeps(pkg), ["js-yaml", "typebox", "typescript", "ws"], "production dependency allowlist drift: update TODO/README/CHANGELOG when changing runtime dependencies");
