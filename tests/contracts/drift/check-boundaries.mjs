...
assert.deepEqual(scripts, ["build-bridge.mjs", "generate-tool-docs.mjs", "run-check-groups.mjs", "sync-bridge-config.mjs", "sync-doc-indexes.mjs", "sync-native-protocol.mjs"], "scripts/ must contain only generators/build/check runners; move tests to tests/");
