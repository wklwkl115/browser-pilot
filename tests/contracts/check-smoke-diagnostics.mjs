...
assert(smoke.includes("PI_BROWSER_SMOKE_BROWSER_RESULT_PATH") && smoke.includes("smoke-orchestration-result.json") && smoke.includes("smoke-window-tabgroups-result.json") && smoke.includes("smoke-orchestration-persistence-result.json"), "smoke-browser must write configurable smoke and orchestration full-envelope artifacts");
