...
assert(setupAction.includes("actions/setup-node@v4") && setupAction.includes("npm ci") && setupAction.includes("npm run build:bridge"), "setup-node-build composite action must encapsulate setup/install/build steps");
