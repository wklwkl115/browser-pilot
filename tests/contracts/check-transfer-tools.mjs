...
assert(validation.includes("UPLOAD_REQUIRES_BROWSER_UPLOAD"), "browser_execute must not bypass browser_upload validation");
assert(read("src/tools/registerExecuteTool.ts").includes("rejectUnsafeExecuteCommand"), "browser_execute must block unsafe transfer.upload bridge commands");
