...
// ABML R1 — a typed relation edge on an entity (targetRef is a materialized bp-ref://).
...
export const ScanSummarySchema = Type.Object({
	...
	focus: Type.Object({
		entityShape: Type.Optional(Type.String()),
		top_layer: Type.Optional(UnknownValue),
		...
		primary_entities: Type.Array(Type.String()),
		list_entities: Type.Array(Type.String()),
		referenced_entities: Type.Optional(Type.Array(Type.String())),
		visual_regions: Type.Optional(Type.Array(Type.String())),
