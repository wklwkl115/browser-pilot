...
export const BROWSER_PILOT_WORKER_STARTED_AT = serviceWorkerGlobal.__BROWSER_PILOT_WORKER_STARTED_AT__ ?? Date.now();

export const BROWSER_PILOT_WORKER_BOOT_ID =
	serviceWorkerGlobal.__BROWSER_PILOT_WORKER_BOOT_ID__ ??
	[
