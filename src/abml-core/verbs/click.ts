...
export type AbmlClickExecutor = (input: AbmlClickInput) => Promise<{ data?: Record<string, unknown>; actionability?: ActionabilityReport; verification?: VerificationResult; diff?: EntityDiff }>;
