...
import { TAB_SCOPED_TOOL_GUIDELINE, browserCookieBindingParams, executeWebSecurityToolShell, maxDepthParam, maxPagesParam, sharedWebSecurityParams, normalizeWebSecurityToolParams, type CrawlToolParams } from "./shared";
...
export function registerCrawlTool({ pi, ensureStarted }: ToolRegistrarContext) {
	pi.registerTool({
		...
		parameters: Type.Object({
			...
			...maxDepthParam("Maximum crawl depth; default 2, hard-capped at 5."),
			...maxPagesParam("Maximum pages/resources fetched; default 50, hard-capped at 500."),
