...
import { asString, isRecord, sha256Hex, stringList, tryJson } from "../shared/normalize";
...
export function knownFilePaths(value: unknown): string[] {
...
export function inScope(url: string, seedOrigins: Set<string>, sameOrigin: boolean): boolean {
...
export function absolutizeMaybe(raw: string, baseUrl: string): string | undefined {
...
export function extractAttributeUrls(html: string, baseUrl: string) {
...
export function extractManifestUrls(html: string, baseUrl: string): string[] {
	const out: string[] = [];
...
export function extractServiceWorkerUrls(text: string, baseUrl: string): string[] {
	const out: string[] = [];
...
export function extractSourceMapUrls(text: string, baseUrl: string): string[] {
	const out: string[] = [];
...
export function extractForms(html: string, baseUrl: string) {
...
export function endpointKindFor(url: string, fallback: string): string {
...
export function extractStringUrls(text: string, baseUrl: string) {
...
export function extractKnownFileUrls(text: string, baseUrl: string) {
...
export function detectApiSpec(bodyText: string, url: string, contentType: string): Record<string, unknown> | undefined {
...
export function detectGraphqlSchema(bodyText: string): Record<string, unknown> | undefined {
	const parsed = tryJson(bodyText);
...
export function shouldProbeGraphqlIntrospection(url: string, contentType: string): boolean {
	return endpointKindFor(url, "") === "graphql" || /graphql/i.test(contentType);
}

export async function parseSourceMapDetails(bodyText: string, url: string, ensureArtifactRoot: () => Promise<string>): Promise<Record<string, unknown> | undefined> {
...
export function extractServiceWorkerCacheRoutes(text: string, baseUrl: string): Array<Record<string, unknown>> {
...
export function extractServiceWorkerVersionSummary(text: string, baseUrl: string) {
