...
export type TruncationInfo = { truncated: true; truncationReason: string; bytesRead?: number; byteLimit?: number; matchesFound?: number; matchLimit?: number };
...
export type BrowserArtifactReadResult =
	...
	| { mode: "inspect"; summary: Record<string, unknown>; kind?: string; schemaVersion?: number; saved?: Record<string, unknown>; jsonPaths?: Record<string, string>; preferredReads?: Array<Record<string, unknown>>; pathDescriptions?: Array<Record<string, unknown>>; compactSummary?: Record<string, unknown>; malformed?: boolean };
