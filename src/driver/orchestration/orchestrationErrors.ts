...
export const ORCHESTRATION_ERROR_CODES = {
	...
	ASSERTION_INVALID: "ORCHESTRATION_ASSERTION_INVALID",
	ASSERTION_FAILED: "ORCHESTRATION_ASSERTION_FAILED",
	ASSERTION_PROBE_FAILED: "ORCHESTRATION_ASSERTION_PROBE_FAILED",
} as const;

const RETRYABLE_CODES = new Set<string>([
	ORCHESTRATION_ERROR_CODES.TIMEOUT,
	ORCHESTRATION_ERROR_CODES.LOCKED,
	ORCHESTRATION_ERROR_CODES.ASSERTION_PROBE_FAILED,
	"BRIDGE_TIMEOUT",
