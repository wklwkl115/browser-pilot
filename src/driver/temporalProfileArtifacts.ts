...
import type { TemporalFrontierNext, TemporalProfileSample, TemporalReason, TemporalVerdictStatus } from "../temporal-core/types.js";
...
function artifactRoot(cwd = process.cwd()): string {
	return path.resolve(cwd, ".pi", "browser-artifacts");
}
