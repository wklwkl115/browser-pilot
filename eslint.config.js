...
export default tseslint.config(
	...
	// monolithic control flow cannot silently accumulate again.
	{
		files: [
			...
			"src/bridge/extension/service_worker/wait_selector.ts",
			"src/browser-runtime/abml/axRuntime.ts",
			"src/browser-runtime/abml/runtime.ts",
			"src/kernels/temporal/classify.ts",
			...
			"src/commands/webSecurity/browserNative/fuzzParams.ts",
			"src/commands/webSecurity/browserNative/fuzzVhosts.ts",
			"src/commands/webSecurity/browserNative/httpReplay.ts",
			"src/commands/webSecurity/browserNative/oastWorkerManager.ts",
			"src/commands/webSecurity/bridges/nucleiBridge.ts",
