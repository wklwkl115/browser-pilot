...
- Use `mise run verify` before claiming completion; it is the release-readiness gate and already includes reachability audit, typecheck, lint, tests, and build.
