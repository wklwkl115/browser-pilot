...
const FIELD_NOTES = Object.freeze({
	...
	"ScanSummarySchema.identity": "Compact ABML identity-lattice diagnostics; full byRef graph stays in observe artifacts.",
	...
	"DistilledEnvelope.identity": "ABML identity-lattice coverage summary; full graph is artifact-only.",
...
const ENVELOPE_PRODUCERS = Object.freeze({
	...
	identity: "src/tools/resultMiddleware.ts:envelopeIdentity()",
