...
const groups = {
	...
	contracts: ["check:jshookmcp-closure", "check:scan", "check:content-pick", "check:transfer", "check:web-security", "check:page-scripts", "check:fake-ws", "check:lifecycle", "check:runtime-fixtures", "check:smoke-diagnostics", "check:paths", "check:token", "check:summaries", "check:artifact", "check:errors", "check:eval-workflows", "check:browser-workflow-results", "check:browser-commands", "check:distiller-coverage", "check:output-schema-conformance", "check:tool-parameter-contract", "check:tool-parameter-framework-validation", "check:mcp-parameter-contract", "check:mcp-conformance", "check:mcp-tools-list", "check:mcp-resources", "check:mcp-ingress-handles", "check:mcp-middleware", "check:mcp-e2e", "check:mcp-structured-envelope", "check:mcp-etag", "check:mcp-sections", "check:mcp-list-changed", "check:token-economy"],
};
