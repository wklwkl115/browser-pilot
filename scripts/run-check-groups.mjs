...
const groups = {
	...
	docs: ["check:tool-docs", "check:doc-structure", "check:boundaries", "check:distill-core-boundary", "check:recovery-boundary", "check:abml-core-boundary", "check:cli-migration-drift"],
	contracts: ["check:jshookmcp-closure", "check:scan", "check:content-pick", "check:transfer", "check:web-security", "check:page-scripts", "check:fake-ws", "check:lifecycle", "check:runtime-fixtures", "check:abml-ax-smoke", "check:smoke-diagnostics", "check:paths", "check:token", "check:summaries", "check:artifact", "check:errors", "check:eval-workflows", "check:browser-workflow-results", "check:browser-commands", "check:distiller-coverage", "check:output-schema-conformance", "check:tool-parameter-contract", "check:tool-parameter-framework-validation", "check:summary-boundary", "check:abml-ref-registry", "check:abml-scan-entities", "check:abml-scan-envelope", "check:abml-verb-runtime", "check:abml-ax-runtime", "check:abml-relation-graph", "check:abml-inference", "check:abml-diff", "check:abml-causal", "check:abml-templating", "check:abml-tree-diff", "check:abml-semantic-ref-anchor", "check:abml-snapshot-projection", "check:abml-stream-plane", "check:abml-p6p7-runtime", "check:abml-internal-integration", "check:cli-parity", "check:param-surface", "check:cli-json-envelopes", "check:memory-autosurface", "check:memory-lifecycle", "check:token-economy", "bench:distill", "check:session-delta-long-conversation"],
};
