...
const serviceWorkerCommandModules = [
	"network_model", "network", "hook", "evidence", "frame", "html", "screenshot", "transfer", "bridge_info", "core_commands", "exec",
];
const serviceWorkerStartupModules = [
...
await writeFile(path.join(distDir, "build-manifest.json"), JSON.stringify({
	...
	serviceWorkerCommandModules,
	serviceWorkerStartupModules,
