...
These GIFs are captured from an isolated Edge session by [`scripts/capture-readme-demos.mjs`](scripts/capture-readme-demos.mjs). Every state change comes from the public Browser Pilot tools.

### Observe, act, and verify a form
...
### Filter structured records and open the target
...
<img src="https://raw.githubusercontent.com/wklwkl115/browser-pilot/main/docs/assets/demo-network-evidence.gif" alt="Browser Pilot captures the inventory request generated by a real browser action" width="100%">
