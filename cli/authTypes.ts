import type { ConsentDecision } from "../src/driver/consentTypes.js";
...
export const PAIRING_TOKEN_HEADER = "x-pi-pairing-token";
export const ENV_PAIRING_TOKEN = "PI_BROWSER_PAIRING_TOKEN";
export const ENV_REQUIRE_PAIRING = "PI_BROWSER_REQUIRE_PAIRING";
export const ENV_AUTH_STATE_DIR = "PI_BROWSER_AUTH_STATE_DIR";
...
// CLI-side error code surfaced by invokeTool when a tool call hits a held lease (HTTP 409).
