...
- Native command source: `bridge/native_command_schema.json` (browser-pilot-native-commands 0.2.0).
...
| `browser_command` | Browser Command | core | `command`, `tabId`, `targetRef` | Send a bridge command object through the Browser Pilot bridge. | outputPath/artifact; command-<ts>.json | `src/tools/registerCommandTool.ts` |
