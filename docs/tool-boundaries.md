...
|---|---|---|
| `scan` | legacy `browser_scan` | Compact DOM/text perception, Scan Manifest v2, actionables, forms/lists/text signals, DOM-ordered visible rows, visible media candidates, same-origin iframe overview. |
